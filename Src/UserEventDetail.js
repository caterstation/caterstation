...
console.log("event_type, city",event_type, city)
  ...
  const getSelectedVenueText = () => {
    if (indoor) {
      const selectedIndoor = indoor === 'Marriage Hall' ? 'Marriage Hall' : 'Marquee';
      
      return `${selectedIndoor}`;
    }
    if (outdoor) {
      const selectedOutdoor =
        outdoor === 'Farm House' ? 'Farm House' : outdoor === 'Dera' ? 'Dera' : 'Portable Marquee';
  ...
  const handleIndoorChange = (value) => {
    ...
    const requiredService = value === 'Marriage Hall' ? 'Marriage Hall' : 'Marquee';
  ...
  const myEvent = () => {
    if (Event === "five") {
      return (
        ...
        >
          <Text style={{ color: 'black', fontSize: responsiveFontSize(1.8) }}>{getSelectedVenueText()}</Text>
        </TouchableOpacity>
      );
    } else if (Event === "sixth") {
      return (
        <View>
          ...
          <View style={{ flex: 1, height: responsiveHeight(20), marginHorizontal: responsiveWidth(5) }}>
            <TabView
...
/>
        ...
        <Text style={{ color: black, fontSize: responsiveFontSize(1.8), fontWeight: "bold", marginTop: responsiveHeight(2), textAlign:"center", width:responsiveWidth(100) }}>Please let us know  detail about your event</Text>
  ...
  <TextInput
    ...
    style={{ fontSize: responsiveFontSize(1.8), color: black, justifyContent: "center" }}
    placeholderTextColor={black}
  />
</View>
   <View style={[styles.commonBox, { justifyContent: "center" }]}>
  ...
  />
        ...
        <View style={{ flexDirection: "column" }}>
          ...
          <Text style={[styles.commonBox, { paddingTop: responsiveHeight(1.9), fontSize: responsiveFontSize(1.8), color: black }]} >
