...
import headerImge from '../Images/citiess.png'
...
useEffect(()=>{
  getData().then(result=>{console.log(" useEffect",result);});
...
return  result
  ...
  title="Select Cities"
  headerImage={require('../Images/citiess.png')}
/>
...
// const imgS=`https://www.caterstation.pro/api/all-cities/city/${item.image}`
                ...
                return(
                <View style={{ width: '30%',marginBottom:15,  marginHorizontal:5
                }}>
...
<Text style={{fontWeight: '600',marginTop:responsiveHeight(1)}}>{item.city}</Text>
                  </TouchableOpacity>
                  </View>
                )}
              }
