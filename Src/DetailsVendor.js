...
import { View, Text, StyleSheet, Image, Pressable, ScrollView,SafeAreaView, Touchable, TouchableOpacity ,Modal, Alert} from 'react-native'
...
//____________ html to text code with color changing
  ...
  const FirstRoute = ({ slug }) => {
    ...
    return (
      <View style={[ {  flex: 1, backgroundColor:white,width:responsiveHeight(50),}]}>
        ...
        <FlatList
          ...
          ListFooterComponent={
            ...
            <Heading style={{color:black, marginBottom:responsiveHeight(1)}}>Description</Heading>
                            
                            {/* <Text numberOfLines={3} style={{ textAlign: "center", fontWeight: "bold", fontSize: responsiveFontSize(2),color:black, marginBottom:responsiveHeight(2) }}>Description</Text> */}

              <View style={[{  width: responsiveWidth(100),justifyContent:"center", alignItems:"center" }]}>
             
              
              <View style={[{  width: responsiveWidth(80), }]}>
    <RenderHtml contentWidth={width} source={{ html: modifiedHtmldescription}} />
                </View>
          ...
          renderItem={(item) => {
            ...
            return (
              <View style={{ justifyContent: 'center', alignItems: "center", height: responsiveHeight(15), width: responsiveWidth(33.3), marginVertical: responsiveHeight(3) }}>
                <View style={{ justifyContent: 'center', alignItems: 'center', width: responsiveWidth(30), paddingBottom: responsiveHeight(1), }} >
             ...
             style={{
              ...
              height: responsiveHeight(5),
                    ...
                    source={iconSource} />
                  <Text style={{marginTop:responsiveHeight(1.5),color:black}}>{item.item.service_name}</Text></View>
  ...
  const ImageCarousel = ({ selectedImage, imageList, onClosePress ,portfolio_id,vendor_id}) => {
    ...
    useEffect(() => {
      if (selectedImage) {
        const selectedImageIndex = imageList.findIndex(img => `https://www.caterstation.pro/public/vendor/portfolio/${img.image}` === selectedImage);
        const reorderedList = [
        ...
        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', flexDirection: "row" }}>
          <View style={{
            ...
            <View style={{
              ...
              <Text numberOfLines={4} style={{ color: 'black', fontSize: responsiveFontSize(1.5), marginTop: responsiveHeight(2), textAlign: "justify" }}>{item.summary}</Text>
    ...
    return (
      <Modal visible={true} animationType="fade" transparent={true}>
        <View style={{ flex: 1, backgroundColor: 'rgba(0, 0, 0, 0.7)' }}>
          ...
          >
            <Text style={{ color: 'black', fontSize: responsiveFontSize(2) }}>x</Text>
          </TouchableOpacity>
        </View>
  ...
  const SecondRoute = () => {
    ...
    return (
      ...
      <Text style={{color:black, fontSize:responsiveFontSize(2), fontWeight: 'bold', textAlign:'center', marginVertical:responsiveHeight(1),}}>Order Portfolio</Text>
...
<View style={{paddingBottom:responsiveHeight(2)}}>
        <FlatList
          ...
          renderItem={({ item }) => {
            ...
            return (<>
              <View style={{ marginTop: responsiveHeight(2), width: responsiveWidth(100), backgroundColor: "#F0F0F0", paddingVertical: responsiveHeight(1), flexDirection: "row", paddingRight: responsiveHeight(3), }}>
                <View style={{ width: responsiveWidth(18), paddingHorizontal: responsiveWidth(1) }}><Image style={{ borderRadius: 30, height: responsiveHeight(7), width: responsiveWidth(13), }} source={{ uri: img }} /></View>
                <View style={{ width: responsiveWidth(82) }}>
                  <Text style={{ color: black, fontWeight: "bold" }}>{item.person_name}</Text>
                  {/* <Text>Star Ratings</Text> */}
                  <Text numberOfLines={3} style={{ fontSize: responsiveFontSize(1.9),color:black, }} >{item.testimonial}
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#ffffff', }}>
      ...
      <View style={{ height: responsiveHeight(35), width: responsiveWidth(100) }}>
        ...
        <View style={{ position: "relative", }}>
          <View  >
            <Image style={{ height: responsiveHeight(22), width: responsiveWidth(100) }}
        ...
        <View style={{ top: responsiveHeight(15), position: "absolute", borderColor: greyBg, borderBottomWidth: 1, borderBottomColor: greyBg, width: responsiveWidth(100), justifyContent: "center", alignItems: "center", }}>
          ...
          <Image style={{
            ...
            height: responsiveHeight(11), width: responsiveWidth(25),  borderRadius: Math.min(responsiveHeight(20), responsiveWidth(20))  }}
          ...
          <View style={{marginHorizontal:responsiveWidth(2), justifyContent:"center", alignItems:"center"}}>
            <Text style={{ color:black,marginTop: responsiveHeight(1), letterSpacing: 1, fontSize: responsiveFontSize(1.8) }}>{item.company_name}</Text>
            <View style={{flexDirection:"row"}}>
              <View style={{justifyContent:"center",alignItems:"center", height:responsiveHeight(2)}}>
            <Entypo name="location-pin" color={black} size={14} />


              </View>

            <View style={{ flexDirection: "row", justifyContent: "center", alignItems: "center", marginBottom: responsiveHeight(1.2), marginHorizontal:responsiveWidth(2),}}>
  
  
             
              <Text style={{ color:black,letterSpacing: 1.5, fontSize: responsiveFontSize(1.8), textAlign:"center" }} >{item.address}</Text>
...
<Modal visible={isModalConfirm==true}>
  <View><Text>
  In publishing and graphic design, Lorem ipsum (/ˌlɔː.rəm ˈɪp.səm/) is a placeholder text commonly used to demonstrate the visual form of a document or a typeface without relying on meaningful content. Lorem ipsum may be used as a placeholder before the final copy is available. It is also used to temporarily replace text in a process called greeking, which allows designers to consider the form of a webpage or publication, without the meaning of the text influencing the design.
      ...
      />
       <Modal visible={isModalConfirm} animationType="fade" transparent={true}>
      <View style={{ flex: 1, backgroundColor: 'rgba(0, 0, 0, 0.7)',  }}>
        <View>
          <Text>thank you</Text>
        </View>
