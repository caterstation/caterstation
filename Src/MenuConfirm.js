import { View, Text, styleheet, Image, Pressable, StyleSheet, Alert } from 'react-native';
...
const handleSubmit=async()=>{
    ...
    console.log('handle')
    try {
        await axios.post('https://caterstation.pro/api/store-menu-data', { 
            MenuName:MyMenu,
            Suggestion,
            AddOns:singleArray,
            name,
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: white, paddingHorizontal: responsiveWidth(2), flexDirection: "column" }}>
      <ScrollView>
        <HorizontalBar backPress={() => navigation.goBack()} title={"Order Confirmation"} />
        ...
        <View style={[style.flipshadowcard, { flexDirection: "row" }]}>
          ...
          <View style={{ width: responsiveWidth(60), justifyContent: "center" }}>
            <Text style={{ fontSize: responsiveFontSize(2), color: black, fontWeight: "bold" }}>{MyMenu} Menu</Text>
          </View>
        </View>
        ...
        <View style={[style.flipshadowcard, { flexDirection: "row" }]}>
          ...
          <View style={{ width: responsiveWidth(60), justifyContent: "center" }}>
            <Text style={{ fontSize: responsiveFontSize(2), color: black, fontWeight: "bold" }}>Add Ons</Text>
          </View>
        </View>
...
<View style={{ width: responsiveWidth(100) }}>
  ...
  <View style={{ marginTop: responsiveHeight(2) }}>
    <Text style={{ fontSize: responsiveFontSize(2), color: blue }}>Your Suggestion</Text>
    <View style={[style.flipshadowcard, { flexDirection: "row" }]}>
      <Text>{Suggestion}</Text>
        ...
        <View style={{marginTop:responsiveHeight(4)}}>
                <Text style={{fontSize:responsiveFontSize(2), color:blue}}>Enter your details here
                </Text>
            ...
            <TextInput
              ...
              style={{fontSize: responsiveFontSize(1.8), color: black , marginHorizontal:responsiveWidth(2), borderRadius:8, borderColor:blue,borderWidth:1.5, height:responsiveHeight(5), marginTop:responsiveHeight(3),paddingHorizontal:responsiveWidth(2)}}
            ...
            <View style={{justifyContent:"center", alignItems:"center", marginTop:responsiveHeight(3)}}>
                ...
                style={{height:responsiveHeight(4), width:responsiveWidth(25), justifyContent:"center", alignItems:"center", backgroundColor:blue,borderRadius:5}}>
  <Text style={{color:white, fontSize: responsiveFontSize(2),}}>Submit</Text>  
</Pressable>
            </View>
...
const style=StyleSheet.create({
    flipshadowcard:{
        ...
        marginTop:responsiveHeight(2),
        paddingHorizontal:responsiveWidth(2),width:responsiveWidth(96),
        backgroundColor:white, borderRadius:5,paddingVertical:responsiveHeight(2),
          shadowColor: '#000',
