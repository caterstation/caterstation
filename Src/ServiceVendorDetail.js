...
import { View, Text, StyleSheet, Image, Pressable, ScrollView,SafeAreaView, Touchable, TouchableOpacity ,Modal} from 'react-native'
            ...
            renderItem={(item) => {
              ...
              return (
                <View style={{ justifyContent: 'center', alignItems: "center", height: responsiveHeight(15), width: responsiveWidth(33.3), marginVertical: responsiveHeight(3) }}>
                  ...
                  resizeMode='contain' source={iconSource} />
