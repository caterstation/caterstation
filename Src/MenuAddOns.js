...
const MenuAddOns = ({route}) => {
  ...
  const Steak = [
    {
      label: 'Chicken Steak with Mushroom Sauce',
      value: 'Chicken Steak with Mushroom Sauce',
    },
    {
      label: 'Chicken Steak with Salsa Sauce',
      value: 'Chicken Steak with Salsa Sauce',
    },
    {
      label: 'Chicken Steak with Pineapple Sauce',
      value: 'Chicken Steak with Pineapple Sauce',
    },
  ];
    ...
    <SafeAreaView style={{flex: 1, backgroundColor: white}}>
      <ScrollView
        ...
        <Text
          ...
          Choose items from our Add Ons menu:
        </Text>
        <Text
          style={{
            marginVertical: responsiveHeight(2),
        ...
        <View
          ...
          <Pressable
            onPress={() => {
              ...
              // Update the state with the new array
              setItems(newItems);
              const singleArray = items.reduce(
              ...
              navigation.navigate('MenuConfirm', {
                MyMenu,
                Suggestion,
                singleArray,
              });
