...
const PackageCheckout = () => {
  ...
  return (
    ...
    <ScrollView >
       <View style={{flexDirection:"row",width:responsiveWidth(100), paddingVertical:responsiveHeight(2), paddingHorizontal:responsiveWidth(5), alignItems:"center", borderBottomColor:greyBg, borderBottomWidth:1}}>
       {/* <FontAwsome  name="angle-left" color={"black"} size={20}/> */}
        <BackArrow/>

      <Text style={{marginLeft:responsiveWidth(28), color:black, fontSize: responsiveFontSize(2.5), fontWeight:"bold"}}>Checkout</Text>
    </View>
    ...
    <View style={{flexDirection:"row", justifyContent:"space-between", width:responsiveWidth(60),marginTop:responsiveHeight(1.2) }}>
                ...
                <View style={{width:responsiveWidth(15),  justifyContent:"center", alignItems:"center", }}>
                    ...
                    <Image style={{width:responsiveWidth(15), height:responsiveHeight(8), borderRadius:50}} source={require('../Images/sofa.jpg')}/>
                              ...
                              <Text style={{color:black,  fontSize:responsiveFontSize(2.2), fontWeight: 'bold',}}>User name</Text>
                    ...
                    <Text style={{color:black, fontWeight:"bold", fontSize:responsiveFontSize(2), marginBottom:responsiveHeight(1),}}>Package Checkout Details</Text>
                    ...
                    <View style={{justifyContent:"space-between", flexDirection:"row", marginVertical:responsiveHeight(1)}}>
                        <Text style={styles.txt}>Total Amount</Text>
                        <Text style={styles.txt}>100k</Text>
                    </View>
                    <View style={{width:responsiveWidth(60),flexDirection:"row", marginBottom:responsiveHeight(1), marginTop:responsiveHeight(3), width:responsiveWidth(100)}}>
                    <Text style={styles.txt}>20% Advance Payable Amount PKR 4000</Text>

                    </View>
                    <View style={{width:responsiveWidth(100),flexDirection:"row", alignItems:"center",marginTop:responsiveHeight(1)}}>
                      {/* <View style={{}}></View> */}
                        <View style={{ height:responsiveHeight(1.5), width:responsiveWidth(3), borderRadius:10, backgroundColor:greyBg,marginRight: responsiveWidth(1),}}></View>
                    <Text style={styles.txt}>By clicking  you agree our Terms and Condition </Text>
