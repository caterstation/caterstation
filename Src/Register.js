...
import { View, Text, StyleSheet,  Image, Pressable,TextInput,TouchableOpacity ,ActivityIndicator,Alert,ScrollView,KeyboardAvoidingView , Platform} from 'react-native';
...
const allValidation=()=>{
 ...
 if(password.length<7){
  ...
  if(checkValidEmail==false&&checkValidNum==false&&password.length==0){
    console.log(" empty=   check num :  "+checkValidNum+"    check email :  "+ checkValidEmail +"    check pass : "+ password + "pass length : "+ password.length)

    Alert.alert('Error','Please enter valid email, password and mobile number',[{text: 'OK'}]);
  ...
  if(password.length<7){
    ...
    Alert.alert('Error','Password should be at least 8 characters long',[{text: 'OK'}]);

 
  }
  if(checkValidEmail==false&&checkValidNum==false&&password.length>7){
...
const [isLoading, setIsLoading] = useState(false);
  ...
  const handleSubmit = async () => {
    ...
    if(connection) {
     setIsLoading(true);
    try {
      const response = await axios.post('https://caterstation.pro/api/register', {
        email,
...
<Image style={[{height:responsiveHeight(15),width: responsiveWidth(60) , }]} source={require('../Images/LogoCaterStationWhite.png')}/>
    ...
    <View style={[styles.lowerBox]}>
              ...
              <Text style={[styles.textLight]}>Enter your mobile number for registration</Text>
           ...
           <View>
                      <PhoneInput
                            ...
                            containerStyle={{color: 'black' ,height:responsiveHeight(7), width: responsiveWidth(70), marginTop:responsiveHeight(7), backgroundColor: '#f8f9f9', paddingLeft:responsiveWidth(1),
                            // borderWidth: 2, borderColor:greyBg, borderRadius:1.9,
                            shadowColor: "#cccccc", marginTop:responsiveHeight(3), marginBottom:responsiveWidth(1),
                            elevation: 1.6, 
                          }}
                            textInputProps={{
                              ...
                              style: {fontSize: responsiveFontSize(1.7), backgroundColor: 'transparent',color: 'black' ,height:responsiveHeight(6.8),  width:responsiveWidth(40),justifyContent:"center", alignItems:"center"},
                            }}
                            ...
                            // withShadow
                            // autoFocus
                            codeTextStyle={{ color: 'black' ,fontSize: responsiveFontSize(1.7),height:responsiveHeight(6.5),width:responsiveWidth(12.5),textAlign:"center", paddingTop:responsiveHeight(2.2), }}
                            flagButtonStyle={{width: 25, paddingLeft:20,  width:responsiveWidth(6.5),}}
                          />
           </View>

{checkValidNum?<Text style={{fontSize: responsiveFontSize(1.5), color:"red", fontWeight: 'bold', width:responsiveWidth(70), flexDirection:'row'}}>Wrong Phone Number Format</Text>:null}
...
<View style={{
  ...
  width:responsiveWidth(70),height:responsiveHeight(6.8),
  borderRadius:1.9,
 ...
 <TextInput 
                    style={ { width:responsiveWidth(70),height:responsiveHeight(6.5),    paddingLeft:responsiveWidth(3), justifyContent:"center", alignItems:"center",color:black
...
{checkValidEmail?<Text style={{fontSize: responsiveFontSize(1.5), color:"red", fontWeight: 'bold', width:responsiveWidth(70), flexDirection:'row'}}>Wrong Email Format</Text>:null}
...
<View style={{
  ...
  shadowColor: "#cccccc", marginTop:responsiveHeight(3), marginBottom:responsiveWidth(4),
  elevation: 1.6,
  }}>
 <TextInput 
              style={ { width:responsiveWidth(70),height:responsiveHeight(6.5),    paddingLeft:responsiveWidth(3), justifyContent:"center", alignItems:"center",color:black
...
<Text style={styles.strengthText}> 
          ...
          {/* {password?<Text style={styles.error}>Password should be</Text>:null} */}
             ...
             onPress={()=>{allValidation(),handleSubmit()}}
              style={[styles.BtnBlue,]}>
                           {isLoading ? <ActivityIndicator color="white" /> : <Text style={[{ color: "white", fontSize: responsiveFontSize(1.7) }]}>Register</Text>}
                ...
                <Pressable style={{flexDirection:"row", paddingHorizontal:responsiveWidth(3),paddingVertical:responsiveHeight(1)}} onPress={()=>{navigation.navigate('Login')}}><Text style={{color:greyDark, fontWeight: 'bold',fontSize:responsiveFontSize(1.7)}}>Already Have Account?</Text><Text style={{color:blue, fontWeight: 'bold',fontSize:responsiveFontSize(1.7)}}> Login Now</Text></Pressable>
                </View>
