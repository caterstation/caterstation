      ...
      <View style={[styles.scene, { paddingHorizontal: responsiveWidth(2), backgroundColor: '#ffffff', width: responsiveWidth(100), }]}>
        <FlatList
          ...
          renderItem={(item) => {
            ...
            return (
              <View style={{ justifyContent: 'center', alignItems: 'center', width: responsiveWidth(30), marginHorizontal: responsiveWidth(.5), marginVertical: responsiveHeight(1) }}><Image style={{ height: responsiveHeight(20), width: responsiveWidth(30) }} source={{ uri: img }} /></View>
  ...
  return (
    ...
    <View style={{ height: responsiveHeight(35), width: responsiveWidth(100) }}>
      ...
      <View style={{ top: responsiveHeight(15), position: "absolute", borderColor: greyBg, borderBottomWidth: 1, borderBottomColor: greyBg, width: responsiveWidth(100), justifyContent: "center", alignItems: "center", }}>
        ...
        <Text style={{ marginTop: responsiveHeight(1), letterSpacing: 1, fontSize: responsiveFontSize(1.8) }}>{item.company_name}</Text>
