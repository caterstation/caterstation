    ...
    if (!phoneNumber) {
      ...
      try {
        const response = await axios.post(
          'https://caterstation.pro/api/delete-user',
          {
            id,
          },
          {
      ...
      <View
        ...
        <View
          ...
          <View
            style={{
              ...
              borderRadius:
                Math.min(responsiveWidth(15), responsiveHeight(15)) / 2,
              backgroundColor: '#ccc',
        ...
        {user == '' ? (
          ...
          <View
            ...
            <Text>{user && user?.email != null ? user?.email : 'Email'}</Text>
          </View>
        )}
        ...
        {user == '' ? null : (
          <Pressable
            ...
            <View style={{paddingHorizontal: 20, paddingVertical: 10}}>
              <AntDesign
                name="right"
                style={{marginTop: 3, fontWeight: '1000'}}
                color={black}
                size={14}
              />
            </View>
          ...
          <View
            ...
            <View
              ...
              <Text
                ...
                Are you sure ? Do you want to delete your acount ?
              </Text>
              <View
                style={{
