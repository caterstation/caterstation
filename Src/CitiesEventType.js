...
const [pressedId, setPressedId] = useState(null);
  ...
  return (
    <SafeAreaView style={{backgroundColor:white, flex:1 }}>
      ...
      <View  >
        <View style={{height:responsiveHeight(10), width:responsiveWidth(100),marginBottom:responsiveHeight(2)}}>
...
/>
        ...
        <View style={{paddingHorizontal:responsiveWidth(2), paddingVertical:responsiveHeight(2),width:responsiveWidth(100),}}>
           <FlatList
                  data={event}
...
const styles=StyleSheet.create({
    ...
    questionTxt:{color:"black",paddingHorizontal:responsiveWidth(5), paddingVertical:responsiveHeight(2),},
    questionHeadingTxt:{color:"black",fontSize:responsiveFontSize(1.5), fontWeight:"700",},
